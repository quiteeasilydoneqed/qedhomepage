...
$$
\displaylines{
    \int_{S^{k}}x_i \mathrm{d} x_1\cdots\mathrm{d} x_{k-1} = \int_0^1x_i(1-x_{i})^{k-1}\left(\int_{S^{k-1}}\mathrm{d} x_1 \cdots\mathrm{d} x_{i-1}\mathrm{d} x_{i+1}\cdots\mathrm{d} x_{k-1}\right)\mathrm{d} x_{i}\\
...
        =(n-1)!\int_{S^{n-1}}a_1^{x_1+\cdots+x_n}\mathrm{d} x =(n-1)!a_1\int_{S^{n-1}}\mathrm{d} x =a_1,
}
$$
