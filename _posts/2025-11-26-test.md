...
注: 当 $ a=q $ 时, 有记法 $ \phi(q)=(q;q)_{\infty} $ , 称为欧拉函数. 在不引起混淆的情况下, 有如下简记法: $ (a)_{n}=(a;q)_{n} $ ,  $ (a)_\infty=(a;q)_\infty $ ,  $ (a,b;q)_n=(a;q)_n(b;q)_n $ ,  $ (a,b;q)_\infty=(a;q)_\infty(b;q)_\infty $ , 更多元的情况类似. 使用q-波赫哈默符号, 就有: 
